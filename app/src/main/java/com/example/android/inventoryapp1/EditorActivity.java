...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /**
     * EditText field to enter the product author
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Find views that we will need
        Button callSupplierButton = findViewById(R.id.button_call_supplier);
        ImageView increaseQuantityImageView = findViewById(R.id.image_view_increase_quantity);
        ImageView decreaseQuantityImageView = findViewById(R.id.image_view_decrease_quantity);
        ...
        if (mCurrentBookUri == null) {
            ...
            // Hide the views we don't need in the Add a book activity
            ...
            // Show the views we need in the Edit a book activity
        ...
        mProductAuthorEditText = findViewById(R.id.edit_author_name);
    ...
    private void saveBook() {
        ...
        values.put(BooksEntry.COLUMN_BOOKS_NAME, productNameString);
        values.put(BooksEntry.COLUMN_BOOKS_AUTHOR, productAuthorString);
        values.put(BooksEntry.COLUMN_BOOKS_QUANTITY, quantityString);
        values.put(BooksEntry.COLUMN_BOOKS_PRICE, priceString);
        values.put(BooksEntry.COLUMN_BOOKS_SUPPLIER_NAME, supplierNameString);
        values.put(BooksEntry.COLUMN_BOOKS_SUPPLIER_PHONE, supplierPhoneString);
    ...
    private boolean blankValidation() {
        ...
        if (TextUtils.isEmpty(productNameString)) {
            ...
            return false;
        } else if (TextUtils.isEmpty(productAuthorString)) {
            Toast.makeText(this, "Please add an Author", Toast.LENGTH_SHORT).show();
            return false;
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int productAuthorColumnIndex = cursor.getColumnIndex(BooksEntry.COLUMN_BOOKS_AUTHOR);
