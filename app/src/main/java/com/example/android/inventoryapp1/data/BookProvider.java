...
public class BookProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.inventoryapp1/books" will map to the
        ...
        // For example, "content://com.example.android.inventoryapp1/books/3" matches, but
        // "content://com.example.android.inventoryapp1/books" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case BOOK_ID:
                ...
                // For an example URI such as "content://com.example.android.inventoryapp1/books/3",
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        String productName = values.getAsString(BooksEntry.COLUMN_BOOKS_NAME);
        if (productName == null) {
            throw new IllegalArgumentException("Book requires a name");
        }

        // Check that the author is not null
        String author = values.getAsString(BooksEntry.COLUMN_BOOKS_AUTHOR);
        if (author == null) {
        ...
        Double price = values.getAsDouble(BooksEntry.COLUMN_BOOKS_PRICE);
        if (price == null) {
            throw new IllegalArgumentException("Book requires a price");
        }

        // Check that the supplier name is not null
        String supplierName = values.getAsString(BooksEntry.COLUMN_BOOKS_SUPPLIER_NAME);
        if (supplierName == null) {
            throw new IllegalArgumentException("Book requires a supplier name");
        }

        // Check that the supplier phone number is not null
        String supplierPhoneNumber = values.getAsString(BooksEntry.COLUMN_BOOKS_SUPPLIER_PHONE);
        ...
        // uri: content://com.example.android.inventoryapp1/books
    ...
    private int updateBook(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link BooksEntry#COLUMN_BOOKS_NAME} key is present,
        ...
        // If the {@link BooksEntry#COLUMN_BOOKS_AUTHOR} key is present,
        // check that the product author value is not null.
        if (values.containsKey(BooksEntry.COLUMN_BOOKS_AUTHOR)) {
            String author = values.getAsString(BooksEntry.COLUMN_BOOKS_AUTHOR);
            if (author == null) {
                throw new IllegalArgumentException("Book requires an author");
            }
        ...
        // If the {@link BooksEntry#COLUMN_BOOKS_UANTITY} key is present,
        ...
        // If the {@link BooksEntry#COLUMN_BOOKS_PRICE} key is present,
        // check that the price value is not null.
        if (values.containsKey(BooksEntry.COLUMN_BOOKS_PRICE)) {
            Double price = values.getAsDouble(BooksEntry.COLUMN_BOOKS_PRICE);
            if (price == null) {
                throw new IllegalArgumentException("Book requires a price");
            }
        ...
        // If the {@link BooksEntry#COLUMN_BOOKS_SUPPLIER_NAME} key is present,
        // check that the supplier name value is not null.
        if (values.containsKey(BooksEntry.COLUMN_BOOKS_SUPPLIER_NAME)) {
            String supplierName = values.getAsString(BooksEntry.COLUMN_BOOKS_SUPPLIER_NAME);
            if (supplierName == null) {
                throw new IllegalArgumentException("Book requires a supplier name");
            }
        ...
        // If the {@link BooksEntry#COLUMN_BOOKS_SUPPLIER_PHONE} key is present,
        // check that the supplier phone number value is not null.
        if (values.containsKey(BooksEntry.COLUMN_BOOKS_SUPPLIER_PHONE)) {
            String supplierPhoneNumber = values.getAsString(BooksEntry.COLUMN_BOOKS_SUPPLIER_PHONE);
            if (supplierPhoneNumber == null) {
                throw new IllegalArgumentException("Book requires a supplier phone number");
            }
